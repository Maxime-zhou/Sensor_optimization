...
options = optimoptions('ga','PopulationSize',50,'CrossoverFraction',0.9,'Display','iter', ...
    'MutationFcn', {@mutationuniform, 0.3},'ConstraintTolerance',1e-9, 'FunctionTolerance',1e-9,'PlotFcn', @gaplotbestf);
...
% Q_f = -Q_fiber_2m(Pos_ini,L2,dUdp2,coor2,dx,ddx);
