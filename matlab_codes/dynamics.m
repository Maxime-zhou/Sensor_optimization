...
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% FILE: dynamics.m
% Linear elastodynamics with central difference method
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
post_flag=0;
dynamics_postgmsh                            % write initial conditions 
...
%-----------------------------------------------------------------------------------------
 ...
 if mod(step,Dstep)==0                      % every Dstep wirtes output
  ...
  post_flag=1;
  dynamics_postgmsh                         % saves displacements to create movie
 end
...
post_flag=2;
dynamics_postgmsh                       % post with movie of the displacement field
