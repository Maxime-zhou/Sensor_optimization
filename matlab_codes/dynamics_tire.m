...
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% Linear elastodynamics with central difference method for bouncing tyre
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%-----------------------------------------------------------------------------------------
 ...
 Fe=eval([Etag Atag 'Fe(Xe,bf)']);          % body forces: selfweight 
 F(Ie)=F(Ie)+Fe(Le0);
end
...
U=zeros(neq,1);                              % zero initial displacements
Udd=M.\F;                                    % initial value of accelerations
Ud=Dt/2*Udd;                                 % and of velocities
...
post_flag=0;
dynamics_tire_postgmsh                       % initial postproc operations
...
% explicit contact with penalty approach
 for n=1:analysis.NN                        % loop over the nodes
  dof=nodes(n).dof(2);
  if dof>0 
   y=nodes(n).coor(2)+U(dof);
   if y<0,                                  % if compenetration
    Fg(dof)=Fg(dof)-penalty*y;              % adds contact nodal force
   end       
  end 
 end
...
post_flag=2;
dynamics_tire_postgmsh                      % final output procedures
